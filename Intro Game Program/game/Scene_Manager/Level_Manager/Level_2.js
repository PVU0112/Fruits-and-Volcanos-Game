class Level_2 extends Scene{
    constructor(){
        ...
        this.instantiate(new Item_Spawn_GameObject([1,2,1,4,3,1,1,1,1,1,1,2,4,3],2))
        ...
        this.instantiate(new Annoying_Farmer_GameObject(), new Vector2(550, 525))
        this.instantiate(new Wheels_GameObject(), new Vector2(0,20))
        this.instantiate(new Wheels_GameObject(), new Vector2(30,20))
    ...
    this.instantiate(new Spike_Controller_GameObject(29,-30,700))
