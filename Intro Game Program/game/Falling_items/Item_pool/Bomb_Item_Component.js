class Bomb_Item_Component extends Component {
    Explo_location
    mod_speed
    ...
    update() {
        ...
        //console.log(GameObject.find("Platform Game Object"))
        
        //console.log("Update")
        this.transform.position.y += Time.deltaTime*120 * this.mod_speed
        ...
        if (Collisions.isCollisionGameObjectGameObject(this.gameObject, this.platform)){
            instantiate(new Norm_Bomb_Explosion_GameObject(this.mod_speed),new Vector2(this.Explo_location,this.transform.position.y-70))
            this.gameObject.destroy()
